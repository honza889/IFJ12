...
unitests/interpret/test: obj/dbg/syntax.o obj/dbg/parsexp.o obj/dbg/scanner.o obj/dbg/rcstring.o obj/dbg/value.o obj/dbg/ast.o obj/dbg/alloc.o obj/dbg/bif.o obj/dbg/ial.o
...
unitests/parsexp/test: obj/dbg/parsexp.o obj/dbg/syntax.o obj/dbg/bif.o obj/dbg/scanner.o obj/dbg/ial.o obj/dbg/rcstring.o obj/dbg/value.o obj/dbg/ast.o obj/dbg/alloc.o
...
pack:
	make -C doc
	rm -f pack/ifj12 pack/*.*
	bash -c 'cp src/*[^~] pack/; cp doc/ifj12.pdf pack/dokumentace.pdf; cd pack; tar -zcvf ../xbiber00.tar.gz *'
