...
Po vygenerování abstraktního syntaktického stromu (AST) pomocí syntaktického
analyzátoru je AST procházen sémantickým analyzátorem, který slouží k 
nalezení sémanticky neplatných operací, jako je například dělení
řetězce číslem či sčítání dvou nilů.
...
bla
\subsubsection{LOGOP}
Implementovány stejně, jako veškeré ostatní operátory. % co víc k tomu psat?
