...
~ ~ ~Jádrem lexikálního analizátoru je funkce \texttt{scan}, která čte lexémy ze zdrojového 
...
řádku na kterém se token nachází. Položka data může obsahovat název symbolu, hodnotu ze 
zdrojového souboru, operátor nebo klíčové slovo. Lexikální analizátor nabízí syntaktickému 
analizátoru až 4 tokeny naráz pomocí struktury \texttt{Scanner}.
%=============================================================================
